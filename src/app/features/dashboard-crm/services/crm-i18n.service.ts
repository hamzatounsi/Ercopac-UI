...
const DICTIONARIES: Record<CrmLang, Record<string, any>> = {
  en: {
    ...
    'dashboard.contactedLeads': 'Leads contacted this month',
    'dashboard.vsLastMonth': 'vs last month',
    'dashboard.wonThisMonth': 'Won This Month',
    'dashboard.closedThisMonth': 'Closed this month',
    'dashboard.closingThisWeek': 'Closing This Week',
    'dashboard.closingThisWeekLabel': 'closing this week',
    'dashboard.noClosingsThisWeek': 'No closings this week',
    'dashboard.wonVsTarget': 'Won vs Target',
    ...
    'leads': {
      ...
      'modal': { 'title': 'Create lead', 'fullName': 'Full name *', 'account': 'Account *', 'selectAccount': 'Select account', 'jobTitle': 'Job title', 'email': 'Email', 'phone': 'Phone', 'mobile': 'Mobile', 'source': 'Source', 'owner': 'Owner', 'unassigned': 'Unassigned', 'notes': 'Notes', 'cancel': 'Cancel', 'creating': 'Creating…', 'create': 'Create lead' },
  ...
  fr: {
    ...
    'dashboard.contactedLeads': 'Prospects contactés ce mois-ci',
    ...
    'dashboard.closingThisWeek': 'Clôture cette semaine',
    'dashboard.closingThisWeekLabel': 'clôture cette semaine',
    'dashboard.noClosingsThisWeek': 'Aucune clôture cette semaine',
    'dashboard.wonVsTarget': 'Gagnés vs Objectif',
    'dashboard.ofTarget': 'de l\'objectif',
  ...
  it: {
    ...
    'dashboard.contactedLeads': 'Contatti contattati questo mese',
    'dashboard.vsLastMonth': 'rispetto al mese scorso',
    'dashboard.wonThisMonth': 'Vinti questo mese',
    'dashboard.closedThisMonth': 'Chiusi questo mese',
    'dashboard.closingThisWeek': 'In chiusura questa settimana',
    'dashboard.closingThisWeekLabel': 'in chiusura questa settimana',
    'dashboard.noClosingsThisWeek': 'Nessuna chiusura questa settimana',
    'dashboard.wonVsTarget': 'Vinti vs Obiettivo',
    'dashboard.ofTarget': 'dell\'obiettivo',
    'dashboard.targetLabel': 'Obiettivo',
