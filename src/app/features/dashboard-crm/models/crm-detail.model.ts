...
export interface CrmReports { totalOpportunities: number; totalValue: number; weightedValue: number; byCountry: CrmBreakdown[]; byStage: CrmBreakdown[]; bySupplyCategory: CrmBreakdown[]; materialValue: number; servicesValue: number; }
